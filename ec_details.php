...
<head>
    ...
    <title>Electronics and Communications Engineering Department</title>
    <style>
        body {
...
<div class="container">
    ...
    <div id="kannada-content">
        <h1>ಇಲೆಕ್ಟ್ರಾನಿಕ್ಸ್ ಮತ್ತು ಸಂವಹನ ಇಂಜಿನಿಯರಿಂಗ್ ವಿಭಾಗ</h1>
        <p>ಡಿಎಸಿಜಿ ಸರ್ಕಾರಿ ಪಾಲಿಟೆಕ್ನಿಕ್‌ನಲ್ಲಿ ಇಲೆಕ್ಟ್ರಾನಿಕ್ಸ್ ಮತ್ತು ಸಂವಹನ ಇಂಜಿನಿಯರಿಂಗ್ ವಿಭಾಗವು 2001 ರಲ್ಲಿ ಪ್ರಾರಂಭವಾಯಿತು.</p>
    ...
    <div id="english-content" class="hidden">
        <h1>About Electronics and Communications Engineering</h1>
        <p>The Department of Electronics and Communications Engineering at DACG Government Polytechnic started in the year 2001.</p>
    ...
    <a href="ec_lecture_details.php" class="navigate-button">Go to Lecture Details</a>
