...
<head>
    ...
    <title>Automobile Engineering Department</title>
    <style>
        body {
...
<div class="container">
    ...
    <div id="kannada-content">
        <h1>ಆಟೋಮೊಬೈಲ್ ಇಂಜಿನಿಯರಿಂಗ್ ವಿಭಾಗ</h1>
        <p>ಡಿಎಸಿಜಿ ಸರ್ಕಾರಿ ಪಾಲಿಟೆಕ್ನಿಕ್‌ನಲ್ಲಿ ಆಟೋಮೊಬೈಲ್ ಇಂಜಿನಿಯರಿಂಗ್ ವಿಭಾಗವು 1985 ರಲ್ಲಿ ಪ್ರಾರಂಭವಾಯಿತು.</p>
    ...
    <div id="english-content" class="hidden">
        <h1>About Automobile Engineering Department</h1>
        <p>The Department of Automobile Engineering at DACG Government Polytechnic started in the year 1985.</p>
    ...
    <a href="at_lecture_details.php" class="navigate-button">Go to Lecture Details</a>
