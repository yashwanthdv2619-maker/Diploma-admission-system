...
<div class="container">
    ...
    <div id="kannada-content">
        <h1>ಯಾಂತ್ರಿಕ ಇಂಜಿನಿಯರಿಂಗ್ ವಿಭಾಗ</h1>
        <p>ಡಿಎಸಿಜಿ ಸರ್ಕಾರಿ ಪಾಲಿಟೆಕ್ನಿಕ್‌ನಲ್ಲಿ ಯಾಂತ್ರಿಕ ಇಂಜಿನಿಯರಿಂಗ್ ವಿಭಾಗವು 1958 ರಲ್ಲಿ ಪ್ರಾರಂಭವಾಯಿತು.</p>
    ...
    <div id="english-content" class="hidden">
        <h1>About Mechanical Engineering Department</h1>
        <p>The Department of Mechanical Engineering at DACG Government Polytechnic started in the year 1958.</p>
    ...
    <a href="me_lecture_details.php" class="navigate-button">Go to Lecture Details</a>
